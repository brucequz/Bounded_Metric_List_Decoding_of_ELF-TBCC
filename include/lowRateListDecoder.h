...
enum class SSD_TYPE { TRELLIS_TYPE = 1, TBCC_TYPE = 2 };
...
class LowRateListDecoder {
  ...
  // genie-Aided
  MessageInformation genieAided_LowRateDecoding_MaxAngle_ProductMetric(std::vector<float> receivedMessage,
                                                                       std::vector<int> transmittedCodeword,
                                                                       std::vector<int> punctured_indices,
                                                                       bool push_to_boundary);
  MessageInformation genieAided_LowRateDecoding_MaxListsize_Collect(std::vector<float> receivedMessage,
                                                                    std::vector<int> punctured_indices,
                                                                    std::vector<int> transmittedCodeword,
  ...
  bool isGabrielNeighbor(std::vector<std::vector<int>> G_mat,
  ...
  std::vector<std::vector<cell>> constructLowRateTrellis_Punctured(const std::vector<float>& receivedMessage,
                                                                   const std::vector<int>& punctured_indices);
  std::vector<std::vector<cell>> constructLowRateTrellis_Punctured_ProductMetric(
