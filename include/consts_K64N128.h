...
constexpr int kconv = 1;                                   /* Number of input bits */
constexpr int nconv = 2;                                   /* Number of output bits */
...
const std::vector<int> PUNCTURING_INDICES = {
    4,  10, 21,  24,  31,  37,  42,  48,  59,  62,  69, 75, 80,
    86, 97, 100, 107, 113, 118, 124, 135, 138, 145, 151}; /* 2023 ISTC paper puncturing pattern */
...
constexpr char ERROR_RUN_TYPE =
    'T'; /* Accumulate to which type of error: {U: undetected, T: total}*/
