...
const int k = 1;                      /* Number of input bits */
const int n = 2;                      /* Number of output bits */
...
const std::vector<int> PUNCTURING_INDICES = {
    ...
    27, 28, 33, 34, 39, 40, 45, 46}; /* 2023 ISTC paper puncturing pattern */
...
inline constexpr char ENCODING_RULE = 'T';     /* Select code type: {Z: zero-terminated CC, T: tail-biting CC} */
