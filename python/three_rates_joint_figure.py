...
def main():
  ...
  SLVD_K11N30_fer = sim_result(num_sims=np.array([30548, 69853, 183843, 270313, 1e6]),
  ...
  ax.set_yscale('log')
  plt.semilogy(rcu_k11n30[:,1], rcu_k11n30[:,3], color=professional_palette['Indigo'][0], linestyle='-.', linewidth=1.5, label='(30, 11) Random Coding Union Bound')
  plt.semilogy(na_k11n30['ebno_dB'], na_k11n30['P_na'], color=professional_palette['Indigo'][1], linestyle='--', linewidth=1.5, label='(30, 11) Normal Approximation')
  plt.semilogy(SLVD_K11N30_fer.ebno_dB, SLVD_K11N30_fer.num_errors/SLVD_K11N30_fer.num_sims, '-^', 
            linewidth=2, 
            color=professional_palette['Indigo'][2],
  ...
  plt.semilogy(dsub_10011_k11n30['ebno_dB'], dsub_10011_k11n30['dsub'], '-', 
            ...
            marker='v',
            markevery=5,
            color=professional_palette['Indigo'][3],
            label=r'(30, 11) Distance Spectrum Union Bound', 
            markerfacecolor='none')
  cx, cy = 3.9, 3e-3
  h = cy * (10**0.1 - 10**-0.1)
  ax.add_patch(Ellipse((cx, cy), 0.8, h, edgecolor=professional_palette['Indigo'][0], fc='none', lw=2))
  ax.text(4.7, 2e-3, "(30, 11)", color='black', fontsize=11, ha='center')

  # - k21n62
  plt.semilogy(rcu_k21n62[:,1], rcu_k21n62[:,3], color=professional_palette['Teal'][0], linestyle='-.', linewidth=1.5, label='(62, 21) Random Coding Union Bound')
  plt.semilogy(na_k21n62['ebno_dB'], na_k21n62['P_na'], color=professional_palette['Teal'][1], linestyle='--', linewidth=1.5, label='(62, 21) Normal Approximation')
  plt.semilogy(SLVD_K21N62_fer.ebno_dB, SLVD_K21N62_fer.num_errors/SLVD_K21N62_fer.num_sims, '-^', 
            linewidth=2, 
            color=professional_palette['Teal'][2],
            label=r'(62, 21), SLVD (ML Performance)', 
            markerfacecolor='none')
  plt.semilogy(dsub_11101101001['ebno_dB'], dsub_11101101001['dsub'], '-', 
          linewidth=1.5, 
          color=professional_palette['Teal'][3],
          marker='v',
          markevery=5,
  ...
  cx, cy = 3.85, 1.5e-4
  h = cy * (10**0.1 - 10**-0.1)
  ax.add_patch(Ellipse((cx, cy), 0.4, h, edgecolor=professional_palette['Teal'][0], fc='none', lw=2))
  ax.text(3.5, 7e-5, "(62, 21)", color='black', fontsize=11, ha='center')

  # -k51n126
  plt.semilogy(rcu_k51n126[:,1], rcu_k51n126[:,3], color=professional_palette['Amber'][0], linestyle='-.', linewidth=1.5, label='(126, 51) Random Coding Union Bound')
  plt.semilogy(na_k51n126['ebno_dB'], na_k51n126['P_na'], color=professional_palette['Amber'][1], linestyle='--', linewidth=1.5, label='(126, 51) Normal Approximation')
  plt.semilogy(SLVD_K51N126_fer.ebno_dB, SLVD_K51N126_fer.num_errors/SLVD_K51N126_fer.num_sims, '-^', 
          linewidth=2, 
          color=professional_palette['Amber'][2],
  ...
  plt.semilogy(SLVD_K51N126v8_fer.ebno_dB, SLVD_K51N126v8_fer.num_errors/SLVD_K51N126v8_fer.num_sims, '-^', 
          linewidth=2, 
          color=professional_palette['Amber'][3],
  ...
  cx, cy = 2.35, 1e-3
  h = cy * (10**0.1 - 10**-0.1)
  ax.add_patch(Ellipse((cx, cy), 0.4, h, edgecolor=professional_palette['Amber'][0], fc='none', lw=2))
  ...
  legend_elements = [
    ...
    Line2D([0], [0], color='black', lw=2, linestyle='-.', label='Random Coding Union Bound'),
    Line2D([0], [0], color='black', lw=2, linestyle='-', marker='^', markerfacecolor='none', label='Simulation (ML Performance)'),
    Line2D([0], [0], color='black', lw=2, linestyle='--', label='Normal Approximation')
  ]
